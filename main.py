...
all_lines_simple =  ["💻专享央视频道,#genre#"] + read_txt_to_array('专区/♪优质央视.txt') + ['\n'] + \
             ...
             ["🎥经典影视频道,#genre#"] + read_txt_to_array('专区/♪专享源①.txt') + ['\n'] + \
             ["🍁新港澳台频道,#genre#"] + read_txt_to_array('专区/♪港澳台.txt') + ['\n'] + \
             ["🔮南玻万直播台,#genre#"] + read_txt_to_array('专区/♪台湾台.txt') + ['\n'] + \
             ...
             ["🏀精选赛事频道,#genre#"] + read_txt_to_array('专区/♪sports.txt') + ['\n'] + \
             ["🍹专享定制频道,#genre#"] + read_txt_to_array('专区/♪定制源.txt') + ['\n'] + \
...
# 
all_lines =  ["📺中国央视频道,#genre#"] + sort_data(ys_dictionary,correct_name_data(corrections_name,ys_lines)) + ['\n'] + \
             ["📡中国卫视频道,#genre#"] + sort_data(ws_dictionary,correct_name_data(corrections_name,ws_lines)) + ['\n'] + \
             ["🎬专享影视频道,#genre#"] + read_txt_to_array('专区/♪专享源②.txt') + ['\n'] + \
             ["🎥经典影视频道,#genre#"] + read_txt_to_array('专区/♪专享源①.txt') + ['\n'] + \
             ["💻专享央视频道,#genre#"] + read_txt_to_array('专区/♪优质央视.txt') + ['\n'] + \
             ["📡专享卫视频道,#genre#"] + read_txt_to_array('专区/♪优质卫视.txt') + ['\n'] + \
             ["🍁香港澳门频道,#genre#"] + read_txt_to_array('专区/♪港澳台.txt') + ['\n'] + \
             ["🔮南玻万直播台,#genre#"] + read_txt_to_array('专区/♪台湾台.txt') + ['\n'] + \
             ["💿经典剧集频道,#genre#"] + read_txt_to_array('专区/♪电视剧.txt') + ['\n'] + \
             ["💓优质个源频道,#genre#"] + read_txt_to_array('专区/♪优质源.txt') + ['\n'] + \
             ["👶儿童专享频道,#genre#"] + read_txt_to_array('专区/♪儿童专享.txt') + ['\n'] + \
             ["🌴咪咕直播频道,#genre#"] + read_txt_to_array('专区/♪咪咕直播.txt') + ['\n'] + \
             ["🏀经典体育频道,#genre#"] + sort_data(ty_dictionary,correct_name_data(corrections_name,ty_lines)) + ['\n'] + \
             ...
             ["💖明星专题频道,#genre#"] + sort_data(mx_dictionary,correct_name_data(corrections_name,mx_lines)) + ['\n'] + \
             ["🖥电视主题频道,#genre#"] + sort_data(ztp_dictionary,correct_name_data(corrections_name,ztp_lines)) + ['\n'] + \
             ["🌿新港澳台频道,#genre#"] + sort_data(gat_dictionary,correct_name_data(corrections_name,gat_lines)) + ['\n'] + \
             ["🍒精选国际频道,#genre#"] + sort_data(gj_dictionary,set(correct_name_data(corrections_name,gj_lines))) + ['\n'] + \
             ["🍑全新纪录频道,#genre#"] + sort_data(jlp_dictionary,set(correct_name_data(corrections_name,jlp_lines)))+ ['\n'] + \
             ["🧜‍♂️精选动画频道,#genre#"] + sort_data(dhp_dictionary,set(correct_name_data(corrections_name,dhp_lines)))+ ['\n'] + \
